...
<?php
  ...
  $query = 'SELECT * FROM tblclientinfo WHERE Client_ID ='.$_GET['id'];
  $result = mysqli_query($db, $query) or die(mysqli_error($db));
...
?>
            ...
            <form role="form" method="post" action="cust_edit1.php">
			  ...
			  <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                   <input class="form-control" placeholder="Phone Number" name="address" value="<?php echo $addr; ?>" >
                </div>
              </div>
			   ...
			   <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                   <input class="form-control" placeholder="code" name="code" value="<?php echo $code; ?>" >
                </div>
              </div>
			  ...
			  <div class="form-group row text-left text-warning">
			   ...
			   <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                   <input class="form-control" placeholder="Phone Number" name="phoneH" value="<?php echo $w; ?>" >
                </div>
              </div>
			   ...
			   <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                   <input class="form-control" placeholder="Phone Number" name="phonecell" value="<?php echo $cell; ?>" >
                </div>
              </div>
			   ...
			   <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                   <input class="form-control" placeholder="Phone Number" name="email" value="<?php echo $email; ?>" >
                </div>
              </div>
